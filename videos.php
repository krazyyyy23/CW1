...
<body>
	...
	<div class="body">
						...
						<div>
							<ul>
								<li>
									...
									<p>
										This website template has been designed by <a href="https://www.instagram.com/_.mell0wsvxi_/">Shreya</a> for you, for free. You can replace all this text with your own text. You can remove any link to our website from this website template, you&#39;re free to use this website template without linking back to us. If you&#39;re having problems editing this website template, then don&#39;t hesitate to ask for help on the <a href="http://www.freewebsitetemplates.com/forums/">Forums</a>.
									</p>
								</li>
								<li>
									<h3>This is just a place holder, so you can see what the site would look like.</h3>
		...
		<div>
			...
			<div>
				<h3>Get Updates</h3>
				<a href="https://www.instagram.com/_.mell0wsvxi_/" target="_blank" id="instagram">Instagram</a>
			</div>
		</div>
	</div>
	<div class="footer">
